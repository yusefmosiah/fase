...
Status: Draft
Priority: 1
Requires: [docs/cogent-work-runtime.md, docs/cogent-work-api-and-schema.md]
Owner: Runtime / Work System

## Narrative Summary (1-minute read)

This doc defines the stable compiled worker briefing contract for `cogent`.
...
2. Add `cogent work hydrate <work-id>`.
...
This is the stable hydration contract between `cogent` runtime state and any
execution adapter.
...
```json
{
  ...
  "runtime": {
    "runtime_version": "dev",
    "config_path": "/Users/wiz/.config/cogent/config.toml",
    "state_dir": "/Users/wiz/.local/state/cogent",
...
3. `cogent work hydrate <work-id> [--mode thin|standard|deep]`

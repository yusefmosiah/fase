...
- [internal/cli/serve.go](/Users/wiz/fase/internal/cli/serve.go)
- [internal/cli/mcp.go](/Users/wiz/fase/internal/cli/mcp.go)
- [internal/cli/root.go](/Users/wiz/fase/internal/cli/root.go)
- [internal/service/service.go](/Users/wiz/fase/internal/service/service.go)
- [internal/store/store.go](/Users/wiz/fase/internal/store/store.go)
- OSINT state under `~/fase-evals/osint/.fase/`
- Prior RCA in [docs/rca-three-bugs.md](/Users/wiz/fase/docs/rca-three-bugs.md)

## Findings

### 1. DB corruption: the real single-writer violation is broader than `__run-job`

I agree with the earlier RCA that detached workers bypass the "serve is the writer" design. `__run-job` opens a fresh service and store in its own process at [internal/cli/root.go:2426](/Users/wiz/fase/internal/cli/root.go:2426) and [internal/cli/root.go:2438](/Users/wiz/fase/internal/cli/root.go:2438), then runs `ExecuteDetachedJob`, which updates job runtime and executes the lifecycle directly at [internal/service/service.go:4735](/Users/wiz/fase/internal/service/service.go:4735). That means worker subprocesses do write the same SQLite files independently of serve.
...
- `runServe` binds the requested port, but if it is occupied it silently falls back to port `0` instead of refusing to start at [internal/cli/serve.go:239](/Users/wiz/fase/internal/cli/serve.go:239) through [internal/cli/serve.go:248](/Users/wiz/fase/internal/cli/serve.go:248).
- The replacement instance then overwrites `.fase/serve.json` unconditionally at [internal/cli/serve.go:251](/Users/wiz/fase/internal/cli/serve.go:251) through [internal/cli/serve.go:265](/Users/wiz/fase/internal/cli/serve.go:265).

That behavior is visible in the OSINT repo right now:

- `~/fase-evals/osint/.fase/serve.json` was last written at `2026-03-24 00:23:14` with dead PID `22475` on port `60641`.
- A different `fase serve --auto --port 4244` process is still alive as PID `74443`, started at `Tue Mar 24 00:13:01 2026`, with cwd `/Users/wiz/fase-evals/osint`.
...
The earlier RCA focuses on unhandled panics in goroutines. That is a real hardening gap: the housekeeping, change-watcher, and supervisor goroutines are launched without recovery at [internal/cli/serve.go:345](/Users/wiz/fase/internal/cli/serve.go:345) through [internal/cli/serve.go:378](/Users/wiz/fase/internal/cli/serve.go:378).

But I do not think that is the best primary explanation for the observed symptom.

Why:

- The exact `"fase serve: shutting down..."` and `"fase serve: stopped"` strings are only printed on the signal-handling path at [internal/cli/serve.go:409](/Users/wiz/fase/internal/cli/serve.go:409) through [internal/cli/serve.go:422](/Users/wiz/fase/internal/cli/serve.go:422).
...
- it uses an `http.Client{}` with no timeout at [internal/cli/mcp.go:96](/Users/wiz/fase/internal/cli/mcp.go:96) through [internal/cli/mcp.go:97](/Users/wiz/fase/internal/cli/mcp.go:97)
- it holds `proxyStdoutMu` while reading the full response body at [internal/cli/mcp.go:141](/Users/wiz/fase/internal/cli/mcp.go:141) through [internal/cli/mcp.go:154](/Users/wiz/fase/internal/cli/mcp.go:154)

Those are real problems.

But the deeper issue is that `fase mcp proxy` is not implementing the go-sdk transport model that the server is using:

- The serve endpoint is a `StreamableHTTPHandler` at [internal/cli/serve.go:280](/Users/wiz/fase/internal/cli/serve.go:280) through [internal/cli/serve.go:284](/Users/wiz/fase/internal/cli/serve.go:284).
...
- Our proxy instead invents a separate `/ws` connection at [internal/cli/mcp.go:99](/Users/wiz/fase/internal/cli/mcp.go:99) through [internal/cli/mcp.go:105](/Users/wiz/fase/internal/cli/mcp.go:105) and [internal/cli/mcp.go:192](/Users/wiz/fase/internal/cli/mcp.go:192) through [internal/cli/mcp.go:309](/Users/wiz/fase/internal/cli/mcp.go:309).
...
- MCP `notifications/claude/channel` emitted by `mcpserver.SendChannelEvent` are written to the MCP server writer at [internal/mcpserver/server.go:65](/Users/wiz/fase/internal/mcpserver/server.go:65) through [internal/mcpserver/server.go:81](/Users/wiz/fase/internal/mcpserver/server.go:81), while the proxy only listens for `channel_message` broadcasts from `/ws`, so the two notification paths are not actually the same transport
...
- `PRAGMA integrity_check;` reports corruption for `~/fase-evals/osint/.fase/fase-corrupt3.db`, `~/fase-evals/osint/.fase/fase-corrupt4.db`, and the current `~/fase-evals/osint/.fase/fase.db`.
